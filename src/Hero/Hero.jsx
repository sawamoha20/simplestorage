    ...
    <div className="hero-container">
        <div className="max-w-[1200px] m-auto flex flex-col-reverse md:flex-row">
            <div className="content-right px-4 py-14 flex-1 flex flex-col gap-10">
                <h1 className='text-[35px] lg:text-[60px] font-[700] capitalize','text-primary'>simple <span className='text-[35px] lg:text-[60px] font-[700] capitalize'>storage</span> solutions just for you.</h1>
